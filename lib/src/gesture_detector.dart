...
class SLGestureDetector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    gestures[SLTapGestureRecognizer] = GestureRecognizerFactoryWithHandlers<SLTapGestureRecognizer>(
...
class SLTapGestureRecognizer extends SLBaseTapGestureRecognizer {
  /// Creates a tap gesture recognizer.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  SLTapGestureRecognizer({
    super.debugOwner,
  ...
  bool isPointerAllowed(PointerDownEvent event) {
    if ((onTapDown, onTap, onTapUp, onTapCancel) == (null, null, null, null)) {
      return false;
    }
...
abstract class SLBaseTapGestureRecognizer extends PrimaryPointerGestureRecognizer  {
  /// Creates a tap gesture recognizer.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  SLBaseTapGestureRecognizer({
    super.debugOwner,
    super.supportedDevices,
    super.allowedButtonsFilter,
  }) : super(deadline: Duration.zero);
